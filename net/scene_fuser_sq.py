...
from exp.scene_sq_utils import move_to_origin, normalize_2d_pos, normalize_3dpts, normalize_kpts_pos
...
class SceneSqueezerWithTestQueries(nn.Module):
    ...
    def forward(self, vr_meta: ClipMeta, vr_pt2d: Pt2dObs, r_meta: ClipMeta, r_pt2d: Pt2dObs, r_pt3d: Pt3dObs):
        ...
        with torch.no_grad():
            ...
            r_aggr_ori_scores = aggr_pc_feats(
        ...
        return (
            (log_var.view(1, N), k_feats.view(1, N, -1)),
            (r_pt3d.xyz, r_aggr_feats),
            (r_aggr_ori_feats.squeeze(0), r_aggr_ori_scores),
        )
